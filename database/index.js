...
const CREATE_ORDER =
  'INSERT INTO customer_order( total_price, discount, pay_method, delivery_time, driver_id, customer_id )\
  VALUES( ${total_price}, ${discount}, ${pay_method}, ${delivery_time},\
...
const ORDER_STANDARD_PIZZA =
    ...
    VALUES ( ${standard_pizza_id}, ${crust_id}, ${base_pizza_id}, ${order_id} ) RETURNING order_standard_pizza_id'
